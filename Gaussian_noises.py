...
path = "C:\\Users\\Ashutosh\\Desktop\\DATASET\\"
imgpath =  path + "book_page.jpg"
imgsave = 'C:\\Users\\Ashutosh\\Desktop\\jk.jpg'
...
def main():
    ...
    noisy_filename = 'noise_1' + str(noisy_sigma) + '.jpg'
    print("hello")
    cv2.imwrite(imgsave, noisy_image)
